...
public class DisenoServiceImpl implements IDisenoService {
    ...
    public DisenoRecienteDTO obtenerDisenoMasReciente() {
        List<DisenoRecienteDTO> lista = disenoRepository.obtenerDisenoMasReciente(PageRequest.of(0, 1));
        return lista.isEmpty() ? null : lista.get(0); // Devuelve solo el más reciente
    }
}
