...
public class DisenoController {
    ...
    private final IDisenoService disenoService;

    public DisenoController(IDisenoRepository disenoRepository, IUsuarioRepository usuarioRepository, IDisenoService disenoService) {
    ...
    public DisenoRecienteDTO obtenerDisenoMasReciente() {
        return disenoService.obtenerDisenoMasReciente(); // <-- usamos el service aquí
    }
}
